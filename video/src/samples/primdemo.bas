...
30  REM GRP_LIN% = FN_Lines(9,10,10)
40  REM GRP_TRI_OUT% = FN_TriangleOutline(9,20,10)
50  REM GRP_SOL_TRI% = FN_SolidTriangle(9,30,10)
60  REM GRP_TRI_LST_OUT% = FN_TriangleListOutline(9,40,30)
70  REM GRP_SOL_TRI_LST% = FN_SolidTriangleList(9,70,30)
80  REM GRP_TRI_FAN_OUT% = FN_TriangleFanOutline(19,0,20)
90  REM GRP_SOL_TRI_FAN% = FN_SolidTriangleFan(19,20,20)
100  REM GRP_TRI_STR_OUT% = FN_TriangleStripOutline(19,40,30)
110  REM GRP_SOL_TRI_STR% = FN_SolidTriangleStrip(19,70,30)
120  REM GRP_QAD_OUT% = FN_QuadOutline(29,0,10)
130  REM GRP_SOL_QAD% = FN_SolidQuad(29,10,10)
140  REM GRP_QAD_LST_OUT% = FN_QuadListOutline(29,20,20)
150  REM GRP_SOL_QAD_LST% = FN_SolidQuadList(29,40,20)
160  REM GRP_QAD_STR_OUT% = FN_QuadStripOutline(29,60,20)
170  REM GRP_SOL_QAD_STR% = FN_SolidQuadStrip(29,80,20)
180  REM GRP_REC_OUT% = FN_RectangleOutline(39,0,10)
190  REM GRP_SOL_REC% = FN_SolidRectangle(39,10,10)
200  REM GRP_CIR_OUT% = FN_CircleOutline(39,20,10)
210  REM GRP_SOL_CIR% = FN_SolidCircle(39,30,10)
220  REM GRP_ELL_OUT% = FN_EllipseOutline(39,40,10)
230  REM GRP_SOL_ELL% = FN_SolidEllipse(39,50,10)
240  REM GRP_TER_SML% = FN_TerminalSmallFont(39,60,40)
250  REM GRP_SOL_BMP% = FN_SolidBitmap(49,0,10)
260  REM GRP_MSK_BMP% = FN_MaskedBitmap(49,10,10)
270  REM GRP_BMP_FRM% = FN_BitmapFrames(49,20,10)
280  REM GRP_BMP_SCR% = FN_BitmapScroll(49,30,10)
290  REM GRP_GRP_MOV% = FN_GroupMove(49,40,10)
300  REM GRP_TER_BIG% = FN_TerminalBigFont(49,50,50)
310  REM GRP_TRN_BMP% = FN_TransparentBitmaps(69,0,40)
320  REM GRP_SOL_REN% = FN_Solid3DRender(69,40,20)
330  REM GRP_MSK_REN% = FN_Masked3DRender(69,60,20)
340  REM GRP_TRN_REN% = FN_Transparent3DRender(69,80,20)
350 REM -----------
355 REM ANIMATIONS
357 REM -----------

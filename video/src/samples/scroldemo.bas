...
20 MODE 32: REM 800x600x64 without text area
30 REM MODE 64: REM 800x600x64 with text area
105 T=TIME
106 IF TIME-T<100 THEN GOTO 106
100 FDFLT%=&000F: FHIDE%=&000E: FGRP%=&000E: FSAME%=&0200: FSCROLL1%=&0010: OTF%=&1E17
102 FLEFT%=&0400: FRIGHT%=&0800
...
210 VDU OTF%; 80, tileArrayID%; rootID%; FHIDE%+FSCROLL1%+FLEFT%+FRIGHT%; columns%; rows%; bmpWidth%; bmpHeight%; 800; 600;
...
10120 REM PRINT cmd$;" (";~totalBytes%;" bytes as bitmap ID ";bmpID%;")"
10130 OSCLI cmd$
...
10153 REM PRINT "  copied ";~N%;" from ";~M%;" to ";~count%;" of ";~totalBytes%
10154 bytes%=bytes%-N%: count%=count%+N%: M%=M%+N%
10155 GOTO 10144
10160 REM PRINT: PRINT "=== ";filename$;" sent ==="
10180 ENDPROC
